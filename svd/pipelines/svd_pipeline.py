...
from LoRA.lora import LoraLoaderMixin

from ..models import UNetSpatioTemporalConditionModel
...
class StableVideoDiffusionPipeline(DiffusionPipeline, LoraLoaderMixin):
    r"""
