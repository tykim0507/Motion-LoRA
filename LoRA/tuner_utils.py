...
class BaseTuner(nn.Module, ABC):
    ...
    def inject_adapter(self, model: nn.Module, adapter_name: str):
        ...
        #TODO: this is modified in order to only consider temporal layers!!! Modified for me.
        key_list = [key for key, _ in model.named_modules() if 'temporal_transformer_block' in key]
